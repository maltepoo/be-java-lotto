...
public class LottoGame {
    ...
    public ArrayList<Integer> makeLottoNumbers() {
    ...
    public ArrayList<List<Integer>> getAutoGeneratedLottos(ArrayList<Integer> numbers, int cnt) {
    ...
    public ArrayList<List<Integer>> purchaseLotto(int cnt) {
        ArrayList<Integer> numbers = makeLottoNumbers();
        return getAutoGeneratedLottos(numbers, cnt);
    }
